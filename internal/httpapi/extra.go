...
import (
	...
	"example.com/glassfloat/internal/backup"
	"example.com/glassfloat/internal/model"
	"example.com/glassfloat/internal/policy"
	"example.com/glassfloat/internal/report"
	"example.com/glassfloat/internal/validate"
	"example.com/glassfloat/internal/workflow"
)
...
func (s *Server) handleBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=glassfloat.zip")
	_, _ = w.Write(b)
}
