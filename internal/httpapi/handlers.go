...
import (
	...
	"example.com/glassfloat/internal/search"
	"example.com/glassfloat/internal/textfmt"
)
...
func (s *Server) handleHealth(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, 200, map[string]any{"status": "ok", "records": n, "app": "GlassFloat Bath"})
}

func (s *Server) handleMeta(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, 200, map[string]any{
		"title":  "GlassFloat Bath",
